...
import champollion.parser.file_environment
...
def test_get_file_environment_empty(request):
    ...
    assert champollion.parser.file_environment.fetch(
...
def test_fetch_import_environment(content, expected):
    assert champollion.parser.file_environment.fetch_import_environment(
        content, "test.module"
    ) == expected
...
def test_fetch_expression_environment(
    ...
    assert champollion.parser.file_environment._fetch_expression_environment(
...
def test_fetch_export_environment(content, expected):
    assert champollion.parser.file_environment.fetch_export_environment(
        content, "test.module"
    ) == expected
...
def test_fetch_binding_environment(expression, expected):
    assert champollion.parser.file_environment._fetch_binding_environment(
